...
./researcher-day/setup/msu-sandbox-preflight.sh SANDBOX_PROJECT_ID                # fix what's broken
./researcher-day/setup/msu-sandbox-preflight.sh SANDBOX_PROJECT_ID --check-only   # audit only
```
